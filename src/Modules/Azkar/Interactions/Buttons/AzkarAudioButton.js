const { wrapInteraction, safeError, safeReply } = require('@infrastructure/Discord/Flow/Responder');
    ...
    async execute(interaction) {
        await wrapInteraction(
            ...
            async () => {
                ...
                let audioInfo = require('@modules/Azkar/AzkarModule').getAzkarAudioUrl(buttonId);
