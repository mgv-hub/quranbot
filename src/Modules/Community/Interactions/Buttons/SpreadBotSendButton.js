    ...
    async execute(interaction) {
        ...
        const adContainer = {
            ...
            components: [
                ...
                {
                    type: 10,
                    content: 'اجعل سيرفرك أقرب إلى القرآن والذكر مع بوت إسلامي متكامل يجمع بين **القرآن الكريم، التلاوات، التفاسير، الأذكار، مواقيت الصلاة والتنبيهات** في تجربة واحدة سهلة وسريعة داخل Discord.',
                },
                { type: 14, divider: true, spacing: 1, },
                {
                    type: 10,
