...
module.exports = {
    ...
    async execute(interaction) {
        await wrapInteraction(
                        ...
                        components: [
                            ...
                            { type: 10, content: 'يمكنك الوصول إلى الميزات الإضافية من الأزرار أدناه.' },
                            {
                                ...
                                components: [
                                    ...
                                    { type: 2, custom_id: 'lavalink_status', label: 'سيرفرات الصوت', style: 2 },
                                    { type: 2, custom_id: 'submit_complaint', label: 'تقديم شكوى/اقتراح', style: 2 },
            ...
            { ephemeral: true, context: { label: 'more_features_button' } },
        );
    },
};
