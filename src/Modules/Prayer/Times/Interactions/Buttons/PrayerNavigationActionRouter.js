    ...
    async execute(interaction) {
        try {
            ...
            if (!availableCountries || availableCountries.length === 0) {
                return interaction
                    .followUp({
                        components: [{ type: 17, accent_color: 0xfefdfe, components: [{ type: 10, content: 'لا توجد دول متاحة' }] }],
                        flags: 32832,
                    })
                    .catch(() => {});
            }
            ...
            if (actionId === 'home_prayer' || actionId === 'back_country_prayer') {
                ...
                if (!targetCityName)
                    return interaction
                        .followUp({
                            components: [
                                { type: 17, accent_color: 0xfefdfe, components: [{ type: 10, content: 'لا توجد بيانات لتحديثها' }] },
                            ],
                            flags: 32832,
                        })
                        .catch(() => {});
                ...
                if (!targetCity)
                    return interaction
                        .followUp({
                            components: [{ type: 17, accent_color: 0xfefdfe, components: [{ type: 10, content: 'المدينة غير متاحة' }] }],
                            flags: 32832,
                        })
                        .catch(() => {});
            ...
            try {
                await interaction
                    .followUp({
                        components: [{ type: 17, accent_color: 0xfefdfe, components: [{ type: 10, content: 'حدث خطأ' }] }],
                        flags: 32832,
                    })
                    .catch(() => {});
            } catch (replyErr) {
