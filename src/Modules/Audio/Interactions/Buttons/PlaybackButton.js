...
// const { createSurahResource, createRadioResource, stopPlayer } = require('@modules/Audio/AudioModule');
const { createSurahResource, createRadioResource } = require('@modules/Audio/AudioModule');
