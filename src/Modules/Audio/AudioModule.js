...
function getConnection() {
    if (!_connection) _connection = require('@modules/Audio/Voice/AudioConnection');
    return _connection;
}
function getPlayer() {
    if (!_player) _player = require('@modules/Audio/Playback/PlayerEvents');
    return _player;
}
function getResource() {
    if (!_resource) _resource = require('@modules/Audio/Playback/AudioResource');
    return _resource;
}
function getDuration() {
    if (!_duration) _duration = require('@modules/Audio/Playback/AudioDuration');
    return _duration;
}
function getRecovery() {
    if (!_recovery) _recovery = require('@modules/Audio/Recovery/AudioRecovery');
    return _recovery;
}
function getValidation() {
    if (!_validation) _validation = require('@modules/Audio/Playback/AudioValidation');
    return _validation;
}
