...
const { fetchAdhkarData } = require('@data/Loaders/DataLoaderHttp');
const { validateAdhkarData } = require('@data/Loaders/DataLoaderValidator');
const { _adhkar_fallback_data_ } = require('@data/Loaders/DataLoaderConstants');
