...
const { createSurahResource } = require('@modules/Audio/AudioModule');
const { player_config } = require('@shared/Errors/SysConfig');
    ...
    try {
        ...
        if (guildState.player.state.status === AudioPlayerStatus.Idle) {
            ...
            if (guildState.playbackMode === 'surah') {
                ...
                const { createRadioResource } = require('@modules/Audio/AudioModule');
