...
const {
    getFirebaseServices,
    isWithinRetentionGracePeriod,
    RETENTION_INDEX_PATH,
    retention_ms,
} = require('@infrastructure/Persistence/Firebase/Retention/RetentionCore');
...
module.exports.cleanupInvalidSetupGuilds = cleanupInvalidSetupGuilds;
module.exports.cleanupInvalidGuildStates = cleanupInvalidGuildStates;
module.exports.cleanupInvalidControlIds = cleanupInvalidControlIds;
