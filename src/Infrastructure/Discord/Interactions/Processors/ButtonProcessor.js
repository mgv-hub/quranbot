...
const ROUTE_GROUPS = {
    ...
    contributorsButton: ['show_contributors'],
    adminStatusManager: ['admin_status_manager', 'admin_status_clear', 'admin_status_text_modal', 'admin_voice_status_modal'],
};
...
const PREFIX_ROUTES = {
    ...
    pr_reminder_: 'prayerReminderSetupButton',
};
